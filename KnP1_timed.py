...
for n in range(237,501):
    startTime = time.time()
    s = 1
    g = (n+1)//4+10 #+0 works for pegasus1(g) for n>2, +1 for n>157, +2 for n>178, +3 for n>190, +4 for n>192, +5 for n>12, +6 for n>218, +7 for n>223, +8 for n>228, +10 for n>237
    nodes = 0
    edges = n*(n-1)/2
    c = 0
    c_edges = 0
